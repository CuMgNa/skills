...
- **设备标签是否进入 APP**：PRD 只写「绑定 / 解绑」，未出现我的 / 用户 / 好友标签。APP 的设备列表是否展示标签、是否支持「好友 → 我的」强制替换仍待确认；资料编辑范围本轮已按“所有可见设备均可编辑”处理。
...
**文档版本**：v1.3（完善 US-018 设备详情、资料编辑与定位频率确认闭环）
