...
覆盖目标市场（北美、澳大利亚）真实用户最常用的邮箱，供测试人员注册 / 找回密码用例直接取用。

**北美主流邮箱**

| 邮箱 | 常用域名 | 测试要点 |
| --- | --- | --- |
| Gmail | @gmail.com | 北美市占率第一；重点验证点号 / 加号别名（关注点 2）与垃圾箱命中（关注点 6） |
| Outlook / Hotmail | @outlook.com、@hotmail.com、@live.com | 微软系三域名同属一个账户体系；@hotmail.com 老用户多，贴近真实存量用户 |
| Yahoo Mail | @yahoo.com | 老牌邮箱，收码偶有分钟级延迟，是关注点 5 的典型复现对象 |
| iCloud Mail | @icloud.com、@me.com、@mac.com | 苹果设备用户常用；@me.com / @mac.com 为早期老域名，可验证老域名兼容 |
| AOL Mail | @aol.com | 北美农村及年长用户比例高，与大牧场目标客群重叠，建议覆盖 |
| Proton Mail | @protonmail.com、@proton.me | 加密邮箱，对陌生发件方拦截严格，验证码易进垃圾箱或被直接拦截 |

**澳大利亚本地邮箱**

| 邮箱 | 常用域名 | 测试要点 |
| --- | --- | --- |
| Telstra Mail | @bigpond.com、@bigpond.net.au、@telstra.com.au | 澳洲最大电信运营商邮箱，农场主常用；.com.au 后缀是关注点 1 多级域名校验的典型样本 |
| Optus Webmail | @optusnet.com.au | 澳洲第二大电信运营商邮箱 |
| iiNet / TPG | @iinet.net.au、@tpg.com.au | 澳洲本土 ISP 邮箱；.net.au 后缀可再验证多级域名不被误拦 |

**取用建议**：注册 / 找回密码用例至少覆盖 Gmail、Outlook、iCloud 三个北美主流 + 一个 .com.au 澳洲邮箱，即可同时覆盖「主流邮箱真实收码」与「多级域名不被误拦」两条线；其余邮箱按版本轮换补充。
